...
public class UserControllerTest {
	...
	//MockMvcRequestBuilders.jsonPath   preferences->java->favourites->new Type->Add MockMvcRequest/ResultMatchers
	//The above having been done, use 'andExpect' directly without MockMvcRequestBuilders
	@Test
	public void whenQuerySuccess() throws Exception {
		String result = mockMvc.perform(
				...
				.andExpect(status().isOk()).andExpect(jsonPath("$.length()").value(3)) //The length of the returned collection is 3
				.andReturn().getResponse().getContentAsString();
